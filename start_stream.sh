...
start_stream() {
    ...
    # GStreamer pipeline
    pipeline="videotestsrc ! video/x-raw,width=640,height=480,framerate=30/1 ! textoverlay text="Camera$camera" ! nvvidconv ! nvv4l2h264enc ! h264parse ! rtspclientsink location=rtsp://localhost:8554/stream$camera"
